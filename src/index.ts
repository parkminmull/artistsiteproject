...
async function setupViewer(){
    ...
    await manager.addFromPath("./assets/manson-3.glb")

    // const drillMaterial = manager.materials!.findMaterialsByName('manson-3')[0] as MeshBasicMaterial2
    ...
    function setupScrollanimation(){
        ...
        tl
        .to(position, {x: isMobile ? -6.0 : 2.78, y: isMobile ?  5.5 :  -2.08, z: isMobile ? -3.3 :  0.51,
        ...
        .to(".title-1", { xPercent:'100' , opacity:0,
            scrollTrigger: {
                trigger: ".second",
                start:"top bottom",
                end: "top 80%", scrub: 1,
        ...
        .to(".title-1-2", { xPercent:'100' , opacity:0,
        scrollTrigger: {
            trigger: ".second",
            start:"top bottom",
            end: "top 80%", scrub: 2.5,
            immediateRender: false
    }})

        .to(".eatme", { xPercent:'100' , opacity:0,
        scrollTrigger: {
            trigger: ".second",
            start:"top bottom",
            end: "top 80%", scrub: 4,
        ...
        .to(".title-2", { xPercent:'-100' , opacity:0,
            scrollTrigger: {
                trigger: ".third",
                start:"top bottom",
                end: "top 80%", scrub: 1,
        ...
        .to(".title-2-2", { xPercent:'-100' , opacity:0,
            scrollTrigger: {
                trigger: ".third",
                start:"top bottom",
                end: "top 80%", scrub: 2.5,
        ...
        .to(position, {x: -1.38, y: 0.13, z: 3.68,
            scrollTrigger: {
                trigger: ".third",
                start:"top bottom",
                end: "top top", scrub: true,
        ...
        .to(target, {x: 0.11, y: 1.04, z: 0.22,
            scrollTrigger: {
                trigger: ".third",
                start:"top bottom",
                end: "top top", scrub: true,
